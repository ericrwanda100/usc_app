    ...
    data-aos-easing="ease-in-out">
      ...
      <div class="education-fair">
          ...
          <div class="education-fair-two">
              ...
              <p>If you're thinking about studying abroad, don't miss our Physical Education Fair.r</p>
...
<style scoped>
.education-fair-section{
    margin-left: 30vh;
}
.education-fair-section h3{
    font-size: 30px;
}
.education-fair-section p{
    font-size: 17px;
}
.education-fair-one img{
    width: 100%;
    padding: 5vh;
}
.education-fair-two button a{
    color: white;
}
.education-fair-two button{
    width: 150px;
    height: 40px;
    background: #d8172e;
    color: white;
...
.education-fair-two p{
    font-size: 17px;
}
.education-fair-two h3{
font-size: 30px;
}
.education-fair-two{
    padding: 5vh;
